  ...
  en: [
    {
      ...
      description: "Remote contract role focusing on fraud detection and refunds processing with operational reporting.",
      achievements: [
      ...
      technologies: ["Excel", "Google Sheets", "Looker Studio", "Shopify", "Adyen", "Notion"]
    },
    {
  ...
  es: [
    {
      ...
      company: "Holafly", 
      period: "Jun 2025 – Mar 2026",
      description: "Rol remoto por contrato enfocado en procesamiento de reembolsos, detección de fraude y reportes operacionales.",
      achievements: [
